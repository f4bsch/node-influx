...
describe('results', () => {
    ...
    it('parses a simple table of results', () => {
        ...
        chai_1.expect(r.groups()).to.deep.equal([{ name: 'test_series', tags: {}, rows: r.slice() }]);
    ...
    it('parses grouped results', () => {
        ...
        chai_1.expect(r.group({ tag: 'a' })).to.deep.equal([{ tag: 'a', mean: 1 }, { tag: 'a', mean: 2 }]);
        chai_1.expect(r.group({ tag: 'b' })).to.deep.equal([{ tag: 'b', mean: 3 }, { tag: 'b', mean: 4 }]);
